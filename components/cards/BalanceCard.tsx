...
export default function BalanceCard({ expanded, onToggle }: Props) {
  return (
    <GlassCard
      ...
      floatDuration="3.5s"
      floatDelay="0s"
      positionClass="absolute top-[15%] left-[4%]"
    >
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <p className="text-[10px] font-bold tracking-[0.15em] text-white/50 uppercase">Balance</p>
          <p style={{ fontSize: "10px", color: "rgba(255,255,255,0.4)", marginTop: "3px" }}>by region</p>
        </div>
      </div>
      ...
      <div className="mt-8 pt-6 border-t border-white/10 flex items-center justify-between">
        ...
        <span className="text-sm font-bold" style={{ color: "var(--color-purple-200)" }}>€10,765</span>
      </div>
    </GlassCard>
  );
}
